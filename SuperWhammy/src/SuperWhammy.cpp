...
#define PLUGIN_URI "http://moddevices.com/plugins/mod-devel/Ricochet"
...
{
    SuperWhammy *plugin = (SuperWhammy *)instance;
...
double SuperWhammy::UpdateStep(bool trigger_active,
                      bool latch_mode,
                      double interval_control,
                      bool direction_up,
                      double shift_time,
